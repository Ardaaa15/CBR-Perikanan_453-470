...
- Membangun basis kasus (case base)
- Melakukan pencarian kasus yang paling mirip (case retrieval)
- Menggunakan kembali solusi dari kasus terdahulu (solution reuse)
...
- Pastikan semua file dan dependencies tersedia
